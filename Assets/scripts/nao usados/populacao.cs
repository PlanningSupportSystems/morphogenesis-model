...
//            vertices_individuos += (i.GetComponent<pessoa>().identidadepessoa +1)+ " \"" +   i.name.ToString() +"\"% " + i.GetComponent<pessoa>().euPessoa.minhaCasa.meuNome + " "+ i.GetComponent<pessoa>().euPessoa.meuTrabalho.meuNome + "\n";
        //    vertices_individuos += "%"+(i.GetComponent<pessoa>().identidadepessoa + 1) + " \"" + i.name.ToString() + "\"% " + i.GetComponent<pessoa>().euPessoa.minhaCasa.meuNome + " " + i.GetComponent<pessoa>().euPessoa.meuTrabalho.meuNome + "\n";
