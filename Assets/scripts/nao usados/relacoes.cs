...
//        {
//            geral.GetComponent<levelgenerator>().predios.Add(new Predios("casa" + i, geral.GetComponent<levelgenerator>().casa));
//        }
...
//        {
//            geral.GetComponent<levelgenerator>().predios.Add(new Predios("trabalho" + i, geral.GetComponent<levelgenerator>().trabalho));
//        }
...
//        asCasas.AddRange(geral.GetComponent<levelgenerator>().predios.FindAll((x) => x.meuNome.Contains("casa")));                   // tentando fazer sublist de list. .ADDRANGE resolveu a questao
//        List<Predios> osTrabalhos = new List<Predios>();
//        osTrabalhos.AddRange(geral.GetComponent<levelgenerator>().predios.FindAll((x) => x.meuNome.Contains("trabalho")));                   // tentando fazer sublist de list. .ADDRANGE resolveu a questao
//                                                                                                                                        //        Predios casat;
...
////            Debug.Log("RELACOES-B ATRIBUI RELACOES: nome das casas: " + asCasas[indexCasa].meuNome + "endereco casa: " + asCasas[indexCasa].meuEnderecoXYZ);
...
//        geral.GetComponent<ControleAglomeracao>().TespacoConstruido.text = geral.GetComponent<levelgenerator>().predios.Count.ToString();
//        geral.GetComponent<ControleAglomeracao>().CA_IniciarControle();
...
////        GameObject.Find("TextTotalEC").GetComponent<Text>() = "testando";//= geral.GetComponent<levelgenerator>().totalCasas.ToString();
